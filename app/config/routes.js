...
import Logs from '../screens/transactionlogs';
import EmpTrans from '../screens/employeetransactions';
...
import XServices from '../screens/Services/Services';
...
const TransactionNavigation = createMaterialTopTabNavigator({
	Logs: {
		screen: Logs,
		navigationOptions: {
			tabBarLabel: 'Transaction Logs'
		}
	},
	EmpTrans: {
		screen: EmpTrans,
		navigationOptions: {
			tabBarLabel: 'Pending Request'
		}
	}
},{
	shifting: false,
